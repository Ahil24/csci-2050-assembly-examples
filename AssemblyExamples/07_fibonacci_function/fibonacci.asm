...
; implemented as a function (fib), which takes its arguments via the registers (System V AMD64 ABI calling convention)
...
main:
  ...
  mov rdx, rax            ; argument #3 (the nth Fibonacci number)
	mov	rax, 0
  call printf		          ; call printf
